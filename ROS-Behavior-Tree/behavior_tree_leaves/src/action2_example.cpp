...
BT::ActionTestNode2::ActionTestNode(std::string name) : ActionNode::ActionNode(name)
{
...
BT::ActionTestNode2::~ActionTestNode() {}

void BT::ActionTestNode2::WaitForTick()
{
    while (true)
    {
...
void BT::ActionTestNode2::set_time(int time)
{
    time_ = time;
}
...
void BT::ActionTestNode2::set_boolean_value(bool boolean_value)
{
